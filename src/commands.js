...
// 🔥 НАСТРОЙКИ АВТО-ОБНОВЛЕНИЯ (те же что в index.js)
...
export async function cmdCancel(cfg, chatId) {
  ...
  if (state) {
    ...
    await sendMessage(cfg.telegramToken, chatId, "️ Нет активного процесса.");
  }
}
